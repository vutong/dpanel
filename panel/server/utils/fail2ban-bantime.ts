/** Stepped incremental bantime ladder (× base bantime): 1h → 6h → 24h → 72h → 7d → 30d → 180d */
export const BANTIME_INCREMENT_MULTIPLIERS = [1, 6, 24, 72, 168, 720, 4320] as const

export const BANTIME_INCREMENT_MAX_MULTIPLIER = 4320
...
export function bantimeIncrementMaxSeconds(baseBantime: number): number {
  return baseBantime * BANTIME_INCREMENT_MAX_MULTIPLIER
}
